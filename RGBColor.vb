Public Class RGBColor
    ...
    Public Shared color4 As Color = Color.FromArgb(24, 161, 251)
    Public Shared color5 As Color = Color.FromArgb(249, 88, 155)
    Public Shared color6 As Color = Color.FromArgb(95, 77, 221)
End Class
'Public Shared color6 As Color = Color.FromArgb(24, 161, 251)95, 77, 221
'Public Shared color6 As Color = Color.FromArgb(95, 77, 221)*